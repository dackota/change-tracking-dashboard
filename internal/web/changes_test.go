...
// and R6: on GET /changes, the Changes nav entry is the active link, the
// other registered routes (Timeline, Trackers) render as links but not
// active, and Repositories (no route yet) still renders as an inert
// placeholder — the same shared shell every route builds.
